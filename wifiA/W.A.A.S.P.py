...
def scout_networks(adaptername):
	...
	try:
		os.system(f"sudo airodump-ng #Your cards name + mon#")
...
def packet_capture(Channel, bssID, adapterName):
	try:
		os.system(f"sudo airodump-ng -w outfile -c {Channel} --bssid {bssID} #Your cards name + mon#")
	except Exception:
		pass
...
os.system("sudo rm outfile-01.cap outfile-01.csv outfile-01.kismet.csv outfile-01.kismet.netxml outfile-01.log.csv")
os.system("sudo airmon-ng stop #Your cards name + mon#")
